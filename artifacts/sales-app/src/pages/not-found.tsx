  ...
  return (
    <div className="relative min-h-[100dvh] w-full flex items-center justify-center bg-background px-4">
      ...
      <div className="relative w-full max-w-md rounded-xl border border-border bg-card p-8 text-center shadow-[0_0_0_1px_rgba(255,255,255,0.04)]">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#3DA935]/10 ring-1 ring-[#3DA935]/30">
          <AlertTriangle className="h-6 w-6 text-[#3DA935]" />
        </div>
        ...
        <div className="mt-6">
          <Link href="/">
            <Button className="bg-[#3DA935] text-white hover:bg-[#3DA935]/90">
              Back to dashboard
            </Button>
          </Link>
        </div>
